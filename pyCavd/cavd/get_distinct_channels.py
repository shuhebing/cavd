...
def get_distinc(filename,preci=4,duplicate=False):
    ...
    dist_voidnet = get_distict_channels(voidnet,False)
    ...
    if len(dist_voidnet) < 30:
        ...
        dist_revoidnet = get_distict_channels(voidnet,False)
        return dist_revoidnet

if __name__ == "__main__":
    dist_net = get_distinc("./Li2CO3-LDA.net")
    print_net(dist_net)
