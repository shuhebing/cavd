...
result_file = open(output_path+"com_result_Na.txt","w")
result_file.write('filename\tProblem\n')
Rf_file = open(output_path+"Rf_Na.txt","w")
...
for filename in filenames:
    ...
    print(filename)
    try:
        conn,oneD,twoD,threeD,nei_dises,dims,voids = AllCom(filename, 0.584, 1000, migrant="Na", rad_flag=True, effective_rad=True, rad_file=None, rad_store_in_vasp=True, minRad=0.584, maxRad=0.876)
