...
for filename in filenames:
    ...
    try:
        conn,oneD,twoD,threeD = AllCom(filename, 0.904, 1000, migrant="Li", rad_flag=True, effective_rad=True, rad_file=None, rad_store_in_vasp=True, minRad=0.904, maxRad=1.356)
