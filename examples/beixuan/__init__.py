...
#from ionic_radii import get_ionic_radii
from pymatgen.core.structure import Structure
from pymatgen.analysis.local_env import ValenceIonicRadiusEvaluator

#计算通道和ASA
def com(filename):
    radii = {'C4+': 0.3, 'O2-': 1.28, 'Li+': 1.06}
    ...
    Channel.findChannelsInVornet(vornet,0.5,"test.zchan")
    asa_new("test.zsa",False,atmnet,0.5,0.5,1000)
