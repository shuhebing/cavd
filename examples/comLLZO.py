...
filenames=[]
path = "/home/yeanjiang/yaj/CAVD/examples/poscar/llzo/"
...
for filename in filenames:
    ...
    try:
        conn,oneD,twoD,threeD = AllCom(filename, 0.5475, 1000, migrant="Li", rad_flag=True, effective_rad=True, rad_file=None, rad_store_in_vasp=True, minRad=0.5475, maxRad=0.949)
