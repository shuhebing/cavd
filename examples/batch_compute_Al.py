...
filenames=[]
path = "../../bi_20181216/Li_Na_Mg_Al_cifs/Al/"
...
for filename in filenames:
    ...
    print(filename)
    try:
        conn,oneD,twoD,threeD,nei_dises,dims,voids = AllCom(filename, 0.584, 1000, migrant="Al", rad_flag=True, effective_rad=True, rad_file=None, rad_store_in_vasp=True, minRad=0.584, maxRad=0.876)
